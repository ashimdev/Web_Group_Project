...
exports.handler = function(event, context, callback) {
  const bucketName = 'centennial-video-thumbnails'; // Replace with your S3 bucket name
  ...
  const contentType = 'image/jpeg'; // Replace with the content type of the file you are uploading
